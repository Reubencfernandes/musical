...
import './globals.css';
import './identity.css';
export const metadata: Metadata = { title: 'Kiku Studio — audio into notation', description: 'Turn audio recordings into editable sheet music. Listen, follow the notes, and make it your own.' };
