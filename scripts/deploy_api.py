...
compile(Path('services/api/app.py').read_text(encoding='utf-8'),'app.py','exec')
...
commit=api.upload_folder(repo_id=repo,repo_type='space',folder_path='services/api',ignore_patterns=['__pycache__/**'],commit_message='Keep the API focused on stable ZeroGPU transcription')
